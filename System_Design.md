...
Inputs --> GBM[Geometric Brownian Motion]

GBM --> Paths[Simulated Paths]

Paths --> Payoff[max(ST-K,0)]

Payoff --> Discount[e-rT]

Discount --> MCPrice[Monte Carlo Price]

MCPrice --> Compare[Validation]

BS[Black-Scholes Formula]

BS --> Compare

Compare --> Final[Pricing Accuracy Analysis]
```
...
Engine --> Pricing Models

Pricing Models --> Risk Analytics

Risk Analytics --> Performance Layer
```